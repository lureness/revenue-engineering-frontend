    ...
    return (
      <Empty className="border border-border/70 bg-card/85 shadow-sm">
        <EmptyHeader>
          ...
          <EmptyDescription>
            Você não tem permissão para acessar métricas e logs deste workspace.
          </EmptyDescription>
        </EmptyHeader>
      </Empty>
    );
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <p className="max-w-2xl text-sm leading-7 text-muted-foreground">
                  Selecione usuários, times, contas de provedor ou senders para
                  abrir o detalhe analítico de cada entidade. O backend já
                  correlaciona tráfego da API, métricas e erros recentes.
                </p>
              </div>
            ...
            {isLoadingDrilldown ? (
              ...
              <Empty className="border border-border/70 bg-background/70">
                <EmptyHeader>
                  ...
                  <EmptyTitle>Não foi possível abrir esse drilldown</EmptyTitle>
